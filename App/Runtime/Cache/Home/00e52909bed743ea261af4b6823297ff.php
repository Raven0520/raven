...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/css/templatemo-style.css">
...
<body>
    ...
    <div class="container">
        <section class="col-md-12 content" id="home">
           <div class="col-lg-6 col-md-6 content-item">
               <img src="/Public/images/1.jpg" alt="Image" class="tm-image">
           </div>
       ...
       <section class="col-md-12 content padding" id="Journal">
        <div class="col-lg-6 col-md-6 col-md-push-6 content-item">
           <img src="/Public/images/2.jpg" alt="Image" class="tm-image">
       </div>
   ...
   <section class="col-md-12 content" id="Code">
       <div class="col-lg-6 col-md-6 content-item">
           <img src="/Public/images/3.jpg" alt="Image" class="tm-image">
       </div>
   ...
   <section class="col-md-12 content" id="contact">
       <div class="col-lg-6 col-md-6 col-md-push-6 content-item">
           <img src="/Public/images/4.jpg" alt="Image" class="tm-image">
       </div>
       <div class="col-lg-6 col-md-6 col-md-pull-6 content-item background flexbox">
...
<footer class="col-md-12 content" id="externals">
 <div class="col-lg-6 col-md-6 last">
   <img src="/Public/images/5.png" alt="Image" class="tm-image">
</div>
